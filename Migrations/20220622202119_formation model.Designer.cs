...
namespace crudProjectWebApi.Migrations
{
    ...
    [Migration("20220622202119_formation model")]
    partial class formationmodel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("crudProjectWebApi.Models.Formation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ConcernedPeople")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DateFormation")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("crudProjectWebApi.Models.Formation", b =>
                {
                    b.HasOne("crudProjectWebApi.Models.School", "SchoolRefId")
                        .WithMany()
                        .HasForeignKey("SchoolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SchoolRefId");
                });
